"""Blending experiment: bootstrap (real) + synthetic records.

Tests different blend ratios and scaling scenarios to find optimal
coverage of holdout trajectories.
"""
...
def main(sample_frac: float = 1.0, n_periods: int = 6):
    print("=" * 70)
    print("BLENDING EXPERIMENT: Bootstrap vs Synthetic")
    print("=" * 70)
    ...
    print(f"Train: {n_train_persons} persons")
    print(f"Holdout: {n_holdout_persons} persons")
    ...
    # Save results
    results_path = Path(__file__).parent / "blend_experiment_results.csv"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Blending experiment")
