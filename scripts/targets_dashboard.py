...
"""
    ...
    <table>
        ...
        <tr><td>PolicyEngine</td><td class="check">✓</td><td class="check">✓</td><td>🚧</td><td>🚧</td></tr>
    ...
    <table>
        <tr><th>Category</th><th>PolicyEngine</th><th>PolicyEngine</th><th>Yale</th><th>PSL</th></tr>
        <tr>
